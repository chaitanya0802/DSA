/*Complete Binary Tree using array of max nodes 30 fun- to create,to display,
    to finf parent node , to find left child node, to find right child node */
#include<iostream>
#include<string.h>
#include<math.h>
#define size 30
...
{   
    ...
    int node1index;
    int pnindex;
    cout<<"\n Enter the node whose right child you want to know: ";
    cin>>node1;
    node1index=0;
    for(int i=0;i<size;i++)
    {
    ...
    pnindex=2*node1index+2;
    cout<<"\nThe right child of: "<<node1<<" is: "<<CBT[pnindex].nodedata;
}
