/*Program in C++ to create hashtable of size 10 and function to insert, display,
 delete,search record by linear probing collision technique*/
...
{   
    ...
    {
        cout<<"\nThe key is found successfully.";
        cout<<"\nThe index of key and recod is: "<<pos;
    }
    else
    {
        int i, flag=0;
        for(i=pos+1;i<size;i++)
        {
        if(Hashtable[i].key==key1)
            {
                cout<<"\nThe key is found successfully.";
                cout<<"\nThe index of key and recod is: "<<i;
                flag=1;
                break;
            }
        }
